...
<div class="wrap" id="loadingPicBlock">
	...
	<dl>
		...
		<dd id="ddBrandList">
			<ul>            
				...
				<li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $daohang['parentid']; ?>_0_0/<?php echo $between; ?>">全部</a></li>
                <?php  else: ?>
                <li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_0_0/<?php echo $between; ?>" class="ClassCur" >全部</a></li>
                <?php endif; ?>
		
				<?php $ln=1;if(is_array($two_cate_list)) foreach($two_cate_list AS $two_cate): ?>
					<?php if($cid == $two_cate['cateid']): ?>
					<li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $two_cate['cateid']; ?>_0_0/<?php echo $between; ?>" class="ClassCur"><?php echo $two_cate['name']; ?></a></li>
					<?php  else: ?>
					<li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $two_cate['cateid']; ?>_0_0/<?php echo $between; ?>"><?php echo $two_cate['name']; ?></a></li>
					<?php endif; ?>
	...
	<dl>
		...
		<?php endif; ?>
			<ul>
            	<?php if(!$bid): ?>
				<li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_0_<?php echo $order; ?>/<?php echo $between; ?>" class="ClassCur" style="background:#f08200">全部</a></li> 
                <?php  else: ?>
                <li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_0_<?php echo $order; ?>/<?php echo $between; ?>" style="color:#f08200">全部</a></li>
                <?php endif; ?>				
				<?php $ln=1;if(is_array($brand)) foreach($brand AS $brands): ?>             
				<?php if($brands['id'] == $bid): ?>
				<li><a class="ClassCur" href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $brands['id']; ?>_<?php echo $order; ?>/<?php echo $between; ?>"><?php echo $brands['name']; ?></a></li>   
				<?php  else: ?>
				<li><a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $brands['id']; ?>_<?php echo $order; ?>/<?php echo $between; ?>"><?php echo $brands['name']; ?></a></li>   
				<?php endif; ?>
				<?php  endforeach; $ln++; unset($ln); ?>
			</ul>
		</dd>
	...
	<?php endif; ?>	
	    ...
	    <div class="list_Sort">
		    <dl>
			    <dt>排序</dt>
			    <dd>
                <a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_1/<?php echo $between; ?>" <?php if($order=='1'): ?>class="SortCur"<?php endif; ?>>即将揭晓</a>
                <a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_2/<?php echo $between; ?>" <?php if($order=='2'): ?>class="SortCur"<?php endif; ?>>人气</a>
                <a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_3/<?php echo $between; ?>" <?php if($order=='3'): ?>class="SortCur"<?php endif; ?>>剩余人次</a>
                <a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_4/<?php echo $between; ?>" <?php if($order=='4'): ?>class="SortCur"<?php endif; ?>>最新</a>
                <?php if($order=='5'): ?>
                <a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_6/<?php echo $between; ?>" class="Price_Sort SortCur">价格 <i></i></a>
                <?php  else: ?>
                    <?php if($order=='6'): ?>
                   		<a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_5/<?php echo $between; ?>" class="Price_Sort SortCur">价格 <s></s></a>
                    <?php  else: ?>
                    	<a href="<?php echo WEB_PATH; ?>/goods_list/<?php echo $cid; ?>_<?php echo $bid; ?>_5/<?php echo $between; ?>" class="Price_Sort">价格 <s></s></a>
                    <?php endif; ?>
                <?php endif; ?>
                </dd>
		    </dl>
			...
			<li class="goods-iten" >
				...
				<div class="gl_buybtn">
					<div class="go_buy">
						...
						<a href="javascript:;" title="购物车" class="go_cart fr">购物车</a>
					</div>
				</div>
...
//$.cookie('Cartlist','',{expires:-1,path:'/'});
	...
	if(info.yun[shopid]) {
		var selnum = info.yun[shopid]['num'] ;
	}
	else {
		var selnum = 0;
	}
	...
	info.yun[shopid]={};
	info.yun[shopid]['num']=1+selnum;
	info.yun[shopid]['shenyu']=shenyu;
	info.yun[shopid]['money']=money;
