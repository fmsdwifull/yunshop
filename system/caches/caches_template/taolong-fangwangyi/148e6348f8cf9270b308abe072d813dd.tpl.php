	...
	<div class="login_bg">
		...
		<form class="registerform" method="post" action="">
			...
			<ul>				
                ...
                <li>
                    <span>验证码：</span>
                    <input class="text_verify" name="verify" type="text"  datatype="*4-4" nullmsg="请输入验证码！" errormsg="请输入正确的验证码！"/>
				...
				<li class="end"><span><input name="submit" type="submit" value="登录" class="login_init" ></span>
                    <span><a id="hylinkRegisterPage" tabindex="4" class="reg" href="<?php echo WEB_PATH; ?>/register">立即注册</a></span></li>
			</ul>
			<?php 
