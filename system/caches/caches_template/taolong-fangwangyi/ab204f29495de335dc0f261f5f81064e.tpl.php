...
<div class="R-content">
<!--<div class="member-t"><h2 style="color:#f08200">充值卡充值（淘宝购买的充值卡请在半小时内确认好评）</h2></div>
<br/>
<div class="charge_money_list" style="border:0;border-bottom:1px solid #e6e7e8; padding-bottom:30px; margin-bottom:50px">
		...
		<ul style=" line-height:40px;">
			...
			<a href="http://item.taobao.com" hidefocus="true" target="_blank">500元充值卡购买</a>
			</li>
		</ul>
		</form>
	</div></div>-->
...
<div class="R-content">
	...
	<?php if($bank1['value'] == 'tenpay'): ?>
		...
		<ul class="payment yeepay_click" style="margin-top:20px;">		
