...
<SCRIPT src="<?php echo G_TEMPLATES_STYLE; ?>/js/163css.base.js" type=text/javascript></SCRIPT>
...
<div class="show_content">
	<!-- 商品期数 -->
	<!--<div id="divPeriodList" class="show_Period" style="max-height:99px;border:1px solid #f00">		
		<div class="period_Open" style="border:1px solid #00f"><a class="gray02" click="off" id="btnOpenPeriod" href="javascript:void(0);">展开<i></i></a></div>
		<?php echo $loopqishu; ?>
	</div>-->
	<script>
	...
	<div class="Pro_Details">
		<h1><span>(第<?php echo $item['qishu']; ?>期)</span><span ><?php echo $item['title']; ?></span><span style="<?php echo $item['title_style']; ?>;color:#f08200"><?php echo $item['title2']; ?></span></h1>
		...
		<div id="preview" style="display:none;">
			<div class="jqzoom" id="spec-n1" onClick="window.open('http://sc.xueit.com')" style="border:1px solid #ddd">
				<img height="350" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $item['thumb']; ?>" jqimg="<?php echo G_UPLOAD_PATH; ?>/<?php echo $item['thumb']; ?>" width="350" />
			</div>
			...
			<?php if($sid_code): ?>			
				...
				<div class="Pro_GetPrize">				
					...
					<div class="GetPrize">				    
						<dl>
							<dt>
								<a rel="nofollow" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($sid_code['q_uid']); ?>" target="_blank"><img width="80" height="80" alt="" src="<?php echo replaceimg(get_user_key($sid_code['q_uid'],'img')); ?>"></a>
							</dt>
							<dd class="gray02">
								<p>恭喜 <a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($sid_code['q_uid']); ?>" target="_blank" class="blue"><?php echo get_user_name($sid_code['q_uid']); ?></a>获得了本商品</p>
								<?php if($sid_go_record['ip']): ?>
		...
		<div class="Pro_Detright">
			...
			<div class="Pro_Record">
				<ul id="ulRecordTab" class="Record_tit">
					...
					<li class="Explain orange" style="color:#f08200">什么是<?php echo _cfg('web_name_two'); ?>？</li>
				</ul>
				<div class="Newest_Con hide">
					<ul>
						...
						<?php if(!empty($user['uphoto'])): ?>
							<img src="<?php echo replaceimg($user['uphoto']); ?>" border="0" alt="" width="20" height="20">
						<?php  else: ?>
...
function Cartcookie(cook){
	...
	info.yun[shopid]['shenyu']=shopinfo['shenyu'];
	info.yun[shopid]['money']=shopinfo['money'];
