...
<link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_STYLE; ?>/css/layout-invitation.css"/>
            ...
            <div class="total">
        	    <dt>
            	    </dt><dd>累计收入：<b class="orange"><?php echo $shourutotal; ?></b>元</dd>  <dd>累计(提现/充值)：<b class="orange"><?php echo $zhichutotal; ?></b>元</dd> <dd>佣金余额：<b class="orange"><?php echo $total; ?></b>元</dd><dd><a href="<?php echo WEB_PATH; ?>/member/home/cashout" title="申请提现" class="bluebut">申请提现</a><a href="<?php echo WEB_PATH; ?>/member/home/cashout" title="充值到账户" class="orangebut">充值到<?php echo _cfg('web_name_two'); ?>账户</a></dd>
...
<!--             <div class="record-tit">
            ...
            <div id="divCommissionList" class="list-tab commission gray02"><ul class="listTitle"><li class="w140">用户</li><li class="w150">时间</li><li class="w280">描述</li><li class="w90"><?php echo _cfg('web_name_two'); ?>金额(元)</li><li class="w90">佣金(元)</li></ul>
