...
<div class="left">
	<div class="head">
		<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($member['uid']); ?>" target="_blank">			
			<img id="imgUserPhoto" src="<?php echo replaceimg(get_user_img('160160')); ?>" width="160" height="160" border="0"/>			
		</a>
	</div>
	<div class="head-but">
	...
	<div class="sidebar-nav">
		...
		<p class="sid-line"></p>
        <h3 class="sid-icon05" ><a href="<?php echo WEB_PATH; ?>/member/home/qiandao"><b></b>每日签到</a></h3>
		<p class="sid-line"></p>
		...
		<ul>
			<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/userbuylist"><?php echo _cfg('web_name_two'); ?>记录</a></li>
