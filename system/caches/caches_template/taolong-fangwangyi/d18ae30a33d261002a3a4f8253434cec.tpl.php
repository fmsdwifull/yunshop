...
<div class="show_content">
	...
	<div id="divCalResult" class="Product_Content">	
		...
		<!--幸运号码计算规则-->
					<div class="yghelp">
					<div class="rule">
					<span class="lucky"></span><br>
					幸运号码<br>
					计算规则
					</div>
					<div class="rule_content">
					<b class="index">1</b>取该商品最后购买时间前网站所有商品的最后100条购买时间记录
					<br>
					<b class="index">2</b>每个时间记录按时、分、秒、毫秒依次排列取数值
					<br>
					<b class="index">3</b>将这100个数值与最近一次重庆时时彩开奖号码之和除以该商品总参与人次后取余数，余数加上10000001 即为“幸运<?php echo _cfg('web_name_two'); ?>码”。
					<?php if(!$item['q_content']): ?>
					<br>
					<b>由于网站还未满100条购买记录。所以按照   10000001 + (揭晓时间求和结果与与最近一次重庆时时彩开奖号码之和*100/参与人数) 的余数   即为“幸运<?php echo _cfg('web_name_two'); ?>码”。</b>
					<?php endif; ?>
				</div>
				</div>
				<?php if(!$item['q_content']): ?>
				...
				<div class="RecordOnehundred"><h4> 未满100条计算结果 </h4>
					<div class="ResultBox">
							<div class="box">
							<b class="redtxt Fb"><?php echo $item['q_user_code']; ?></b><br>
							本期幸运号
							</div>
							<div class="boxSign">=(</div>
							<div class="box">
							<b class="redtxt Fb"><?php echo $user_shop_time_add; ?></b><br>
							揭晓时间求和
							</div>
							<div class="boxSign">X100+</div>
							<div class="box">
							<b class="redtxt Fb"><?php echo $user_shop_codes_arr['0']['cqssc']; ?></b><br>
							时时彩开奖号码
							</div>
							<div class="boxSign">)%</div>
							<div class="box">
							<b class="redtxt Fb"><?php echo $item['canyurenshu']; ?></b><br>
							本商品总需参与人次
							</div>
							
							<div class="boxSign">+</div>
							<div class="box">
							<b class="redtxt Fb">1000001</b><br>
							原始数
							</div>		
						</div> 
				   ...
				   <ul class="Record_content">
					...
					<div class="RecordOnehundred"><h4> 100条计算结果 </h4>
					 ...
					 <div class="ResultBox">
							...
							<div class="boxSign">=(</div>
							<div class="box">
							<b class="redtxt Fb"><?php echo $item['q_counttime']; ?></b><br>
							100条<?php echo _cfg('web_name_two'); ?>记录时间之和
							</div>
							<div class="boxSign">+</div>
							<div class="box">
							<b class="redtxt Fb"><?php echo $user_shop_codes_arr['0']['cqssc']; ?> </b><br>
				...
				<?php endif; ?>
					...
					<div class="rule_content">
							<b class="index">1</b>求和：
								<span class="Fb"><?php echo $user_shop_time_add; ?></span>(揭晓时间求和结果)<br>
								<b class="index">2</b>取余：
								<span class="Fb"><?php echo $user_shop_time_add; ?></span>(揭晓时间)
								<span class="Fb"> * 100 / <?php echo $item['canyurenshu']; ?></span>(本商品总需参与人次)
								<span class="Fb"> = </span>
								<span class="squaretTxt "><?php echo $user_shop_fmod; ?></span>
								<span class="squaretTxt ">5</span>
								<span class="squaretTxt ">6</span>
								<span class="squaretTxt ">6</span>
								(余数)<br>
								<b class="index">3</b>结果：
								<span class="squaretTxt "><?php echo $user_shop_fmod; ?></span>
								<span class="squaretTxt ">5</span>
								<span class="squaretTxt ">6</span>
								<span class="squaretTxt ">6</span>
								(余数)
								<span class="Fb"> + 1000001 = </span>
								<b class="ball"> <?php echo $item['q_user_code']; ?></b>
								<b class="ball"> 1</b>
								<b class="ball"> 1</b>
								<b class="ball"> 1</b>
							</p>

							<b class="resultCode">最终结果：<?php echo $item['q_user_code']; ?></b>
							</div>
							</div>
