...
<div class="header header_fixed">
	<div class="header1">
		<div class="header1in">
			<ul class="headerul1">
				<li><a style="padding-left:40px;font-size: 14px;"><i class="header-tel"></i><?php echo _cfg("cell"); ?>
</a></li>
				...
				<li class="phoneli header-WeChatli">
					...
					<img src="<?php echo G_WEB_PATH; ?>/statics/templates/taolong-fangwangyi/images/img/cloud_kik.jpg">
				</li>
