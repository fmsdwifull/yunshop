...
<div class="table-list lr10">
        ...
        <tbody>				
            ...
            <tr>
              <td align='center'><input name='listorders[<?php echo $v['id']; ?>]' type='text' size='3' value='<?php echo $v['order']; ?>' class='input-text-c'></td>
                ...
                <td class="action">
                <a href="<?php echo G_ADMIN_PATH; ?>/content/news_edit/<?php echo $v['id'];?>">修改</a>
                <span class='span_fenge lr5'>|</span>    
                <a href="javascript:window.parent.Del('<?php echo G_ADMIN_PATH.'/content/news_del/'.$v['id'];?>', '确认删除这篇新闻吗？');">删除</a>
				</td>
            </tr>
            <?php } ?>
        </tbody>
   ...
   <div class="btn_paixu">
  	<div style="width:80px; text-align:center;">
        ...
        onclick="myform.action='<?php echo G_MODULE_PATH; ?>/content/news_listorder/dosubmit';myform.submit();"/>
    </div>
  </div>
