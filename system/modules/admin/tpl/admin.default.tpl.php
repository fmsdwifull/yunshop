...
<style>
	...
	.div-button{ float:right;background-color:#fff; float:left; padding:20px; margin:0 10px; width:55%;;border-radius:5px 5px 5px 5px;}
	.div-button ul li{ float:left; margin:0px 10px;}
	.div-button ul{margin-left:auto;margin-right:auto;width:400px;}
...
<div class="div-user lr10">
	<h1>Hello, <font color="#4c6b80"><?php echo $info['username'] ;?></font><h1>
...
<div class="bk15"></div>
	<ul>
    	<li style="width:60px;height:46px;padding-top:14px;" class="title_orange"><a  href="<?php echo G_MODULE_PATH; ?>/content/article_add"><!--<img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_t.png">--><span style="color:#fff;font-weight:bold;">添加文章</span></a></li>
        <li style="width:60px;height:46px;padding-top:14px;" class="title_blue"><a href="<?php echo G_MODULE_PATH; ?>/content/goods_add"><!--<img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_g.png">--><span style="color:#fff;font-weight:bold;">添加商品</span></a></li>
        <li style="width:60px;height:46px;padding-top:14px;" class="title_orange"><a href="<?php echo WEB_PATH; ?>/member/member/list"><!--<img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_m.png">--><span style="color:#fff;font-weight:bold;">会员管理</span></a></li>
        <li style="width:60px;height:46px;padding-top:14px;" class="title_blue"><a href="<?php echo G_MODULE_PATH; ?>/setting/webcfg"><!--<img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_s.png">--><span style="color:#fff;font-weight:bold;">系统设置</span></a></li>
        <li style="width:60px;height:46px;padding-top:14px;" class="title_orange"><a href="<?php echo G_WEB_PATH; ?>"><!--<img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_i.png">--><span style="color:#fff;font-weight:bold;">网站首页</span></a></li>
    </ul>
</div>
