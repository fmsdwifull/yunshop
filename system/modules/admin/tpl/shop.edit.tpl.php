...
<form method="post" action="">
	<table width="100%"  cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>所sdg属分类：</td>
			<td>
...
<tr>
			<td align="right" style="width:120px"><font color="red">*</font>应用场景模式：</td>
			<td>
	    <input  type="radio"   name="scene" value="1" <?php if($shopinfo['scene'] == 1) echo 'checked'; ?>  class="  bg">是
		<input  type="radio"   name="scene" value="2" <?php if($shopinfo['scene'] == 2) echo 'checked'; ?>  class="  bg">否
