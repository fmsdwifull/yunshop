...
<form name="myform" action="" method="post">
  <table width="100%" cellspacing="0">
  	<tr>
		...
		<td><input type="text" name="keyword"  class="input-text wid200"></td>
	</tr>


     <tr>
			<td width="220" align="right">回复内容：</td>
			<td><textarea name="value"  id="text_v" class="wid300" style="height:80px;" disabled='true' ></textarea><span><font color="#0c0">※ </font>回复文本请先点击 回复文本，回复图文则点击选择</span>
            </td>
