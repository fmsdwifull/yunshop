...
<form method="post" action="">
	<table width="100%"  cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td><input  type="text"  name="title" id="title" onKeyUp="return gbcount(this,100,'texttitle');"  class="input-text wid400 bg" value="<?php echo $newsinfo[title]?>">
        ...
        <tr>
			...
			<td><textarea name="description" class="wid400" onKeyUp="gbcount(this,250,'textdescription');" style="height:60px"><?php echo strip_tags($newsinfo['intro']);?></textarea><br> <span>还能输入<b id="textdescription">250</b>个字符</span>
            </td>
		</tr>
		<tr><td></td><td><img src="<?php  echo G_UPLOAD_PATH.'/'.$newsinfo['cover']; ?>" style="width:100px;"></td></tr>

     <tr>
      <td align="right"><font color="red">*</font>封面：</td>
        <td>
           	<input type="text" id="imagetext" name="thumb" class="input-text wid300" value="<?php echo $newsinfo['cover']; ?>">
        ...
        <tr>
			...
			<td><fieldset class="uploadpicarr">
					...
					<div id="selectin">
					<?php if($newsinfo['sonlist']){foreach($newsinfo['sonlist'] as $v){echo "<span onClick='shanchu(this)' title='点击删除' class='tat' >".$v."</span>";}}?></div>
                    				</div>
		...
		<tr>
			...
			<td><input type="text" name="link" value="<?php echo $newsinfo['link'];?>" class="input-text wid300"></td>
		</tr>
       <tr>

			<td align="right">发布时间：</td>
			<td>           
            	<input name="posttime" type="text" id="posttime" value="<?php echo date("Y-m-d H:i:s",$newsinfo['add_time']); ?>" class="input-text posttime"  readonly="readonly" />
				<script type="text/javascript">
				date = new Date();
				Calendar.setup({
					inputField     :    "posttime",
        ...
        <tr height="60px">
			<td align="right"></td>
			<input type="hidden" name="selectin" id="duo" value="<?php echo $newsinfo['son']?>">
...
<script type="text/javascript">
    ...
    ue.addListener('ready',function(){
        ...
        ue.setContent('<?php echo $newsinfo[content]; ?>');
         this.focus() 
    });
