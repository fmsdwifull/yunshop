				...
				success:function(data) {
					...
					if(data.length > 0){
						...
						for(var a=0; a<data.length; a++){
							html += '<tr><td align="right" style="width:120px">'+data[a]+'：</td><td><input type="text"  name="property['+a+']" style="width:200px; padding-left:0px;" class="input-text"><span class="lr10">多个值请用 | 号分割开</span></td></tr>';
						}
						$('#property').html(html);
					}
				}
	...
	<table width="100%"  cellspacing="0" cellpadding="0">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" id="money"  name="money" style="width:80px; padding-left:0px; text-align:center" class="input-text">元</td>
			</tr>
			<tr>
				<td align="right" style="width:120px"><font color="red">*</font>库存：</td>
				<td><input type="text"  name="inventory" style="width:80px; padding-left:0px; text-align:center" class="input-text"></td>
			</tr>
		</tbody>
		<tbody id="property">
