...
<tr><td></td><td style="font-weight:bold;">群发消息每月只能发送4条</td></tr>

     <tr>
			<td width="220" align="right">回复内容：</td>
			<td><textarea name="value"  id="text_v" class="wid300" style="height:80px;" disabled='true' ><?php echo $notinfo['text'];?></textarea><span><font color="#0c0">※ </font>回复文本请先点击 回复文本，回复图文则点击选择</span>
            </td>
...
$('#resnews').click(function(){
	layer.open({
	        ...
	        area : ['800px' , '520px'],
	        content: "<?php echo G_ADMIN_PATH.'/weixin/rule_news_select';?>"
	    });
