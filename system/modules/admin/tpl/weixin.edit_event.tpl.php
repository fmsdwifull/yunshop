...
<form name="myform" action="" method="post">
  <table width="100%" cellspacing="0">
     ...
     <tr>
			...
			<td><textarea name="value"  id="text_v" class="wid300" style="height:80px;" disabled='true' ><?php echo $eventinfo['text'];?></textarea><span><font color="#0c0">※ </font>回复文本请先点击 回复文本，回复图文则点击选择</span>
            </td>
