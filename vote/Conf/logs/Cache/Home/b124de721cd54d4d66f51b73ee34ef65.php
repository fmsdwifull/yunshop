...
<p>请务必认真阅读以下步骤的内容，才能更有效的完成配置工作<br/>
  <?php if($_GET['token'] != ''): ?>你的接口URL是：<font color="red">http://<?php echo ($myurl); ?>/index.php?g=Home&m=Weixin&a=index&token=<?php echo $_GET['token']; ?></font><br>您的token是：<font color="red"><?php echo $_GET['token']; ?></font><?php endif; ?></p>
</div>
                            ...
                            <div class="articleContent catalogHome normalContent">
                                <div class="section lastSection">
                                   <div class="section lastSection">
									...
									<?php else: ?>
									<p>你的URL是 <font color="red">http://<?php echo ($myurl); ?>/index.php?g=Home&m=Weixin&a=index&token=<?php echo $_GET['token']; ?></font></p><?php endif; ?>
