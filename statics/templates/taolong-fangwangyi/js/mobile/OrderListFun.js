                        ...
                        for (var l = 0; l < n; l++) {						 
                            ...
                            if (!p.dizhi) {
                                ...
                                if (q[1] == '未发货'&& q[2]=='未完成') {
                                    ...
                                    if (q[1] == '已发货' && q[2]=='待收货') {
                                        m += '<a href="javascript:void(0);" class="z-gds-btn z-gds-btnDis">已发货</a><a href="javascript:;"  oid=' + o[l].go_id + ' uid='+o[l].uid+' onclick="shouhuo('+o[l].go_id+','+o[l].uid+')" class="z-gds-btn">确认收货</a>'
                                    } else {
                                        if (q[1] == '已发货' && q[2]=='已完成') {
                                            if (o[l].is_shaidan) {
                                                ...
                                                m += '<a href="javascript:void(0);" class="z-gds-btn z-gds-btnDis">订单已完成</a><a href="?/mobile/home/postsingle/' + o[l].go_id + '" class="z-gds-btn">去晒单</a>'
                                            }
                                        } else {
                                            if (q[2] == '已作废') {
